...
public class FavFoodFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstance) {
        View view = inflater.inflate(R.layout.fragment_favourite_food, container, false);
    ...
    private List<MyModel> getList() {
        ...
        String[] foodNames = getResources().getStringArray(R.array.fav_food_names);
        String[] foodDescs = getResources().getStringArray(R.array.fav_food_descs);
        String[] foodImgs = getResources().getStringArray(R.array.fav_food_imgs);
